  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div className="flex items-start gap-3">
          ...
          <HelpPopover
            ...
            tips={[
              "\"Nuevo producto\" abre el formulario completo, incluyendo especificaciones (clave/valor).",
              "El ícono de lápiz edita un producto; el de basura lo elimina.",
              "El stock se descuenta automáticamente cuando se crean pedidos y se devuelve si se cancelan.",
      ...
      <ProductsTable
        ...
        editPathPrefix="/dashboard/admin/productos"
      />
    </div>
  );
}
