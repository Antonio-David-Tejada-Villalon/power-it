...
async function main() {
  ...
  const products = [
    ...
    { sku: "CPU-001", name: "Procesador Ryzen 7 7800X3D", category: "componentes-pc", brand: "AMD", price: 449, stock: 15, images: [IMG("1717444309226-c0809d4b5bde")], specs: { Núcleos: "8", Hilos: "16", Cache: "96MB" }, description: "Procesador líder en gaming con tecnología 3D V-Cache." },
    ...
    { sku: "WEB-001", name: "Webcam 4K Streaming", category: "perifericos", brand: "ClearView", price: 99, stock: 22, images: [IMG("1736836977797-8035ae65c0f8")], specs: { Resolución: "4K30fps" }, description: "Webcam profesional para streaming y videollamadas." },
    ...
    { sku: "SSD-001", name: "SSD NVMe 1TB Gen4", category: "almacenamiento", brand: "DataForge", price: 89, stock: 50, images: [IMG("1757083840018-cd665233a112")], specs: { Capacidad: "1TB", Velocidad: "7000MB/s" }, description: "Almacenamiento ultrarrápido para cargas de trabajo exigentes." },
    ...
    { sku: "ACC-001", name: "Hub USB-C 7 en 1", category: "accesorios", brand: "ConnectPro", price: 45, stock: 60, images: [IMG("1591084336506-9cdca26b4c14")], specs: { Puertos: "USB-C, HDMI, USB-A x3" }, description: "Expande la conectividad de tu laptop en un solo dispositivo." },
